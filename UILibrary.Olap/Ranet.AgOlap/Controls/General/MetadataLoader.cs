...
{
    public class MetadataLoader : IDataLoader
    {
        ...
        public MetadataLoader(String url)
        {
            URL = url;
        }
        ...
        public void LoadData(object schema, object state)
        {
            ...
            service.GetMetaDataCompleted += new EventHandler<Ranet.AgOlap.OlapWebService.GetMetaDataCompletedEventArgs>(service_GetMetaDataCompleted);
            service.GetMetaDataAsync(schema.ToString(), state);
        }

        void service_GetMetaDataCompleted(object sender, Ranet.AgOlap.OlapWebService.GetMetaDataCompletedEventArgs e)
        {
