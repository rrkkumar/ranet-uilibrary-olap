...
namespace Ranet.AgOlap.Features
{
    public static class RichTextExtensions
    {
        ...
        public static TextBox AddMouseWheelSupport(this RichTextBox textBox)
        {
        ...
        /// <returns>The <see cref="TextBox"/>.</returns>
        public static TextBox AddMouseWheelSupport(this RichTextBox textBox, double scrollAmount)
        {
